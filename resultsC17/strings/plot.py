...
plt.plot(x_20pa_t20, vel_20pa_t20, label='Velocity - 60% DC', color='#48A2F1', marker='x', markersize=4 ,markevery=2, linewidth=.9)
plt.plot(x_20pa_t30, vel_20pa_t30, label='Velocity - 65% DC', color='#48A2F1', marker='o', mfc='w', markersize=4 ,markevery=2, linewidth=.9)
plt.plot(x_string_20pa_t20, string_data_20pa_t20, label='String - 60% DC', color='#D81B1B', marker='x', markersize=4 ,markevery=2, linewidth=.9)
plt.plot(x_string_20pa_t30, string_data_20pa_t30, label='String - 65% DC', color='#D81B1B', marker='o', mfc='w', markersize=4 ,markevery=2, linewidth=.9)
